...
BACKUP = os.path.join(BASE, "data", "full_ledger.backup_before_078_20260830.json")
shutil.copy2(LEDGER, BACKUP)
ledger = json.load(open(LEDGER))
events = ledger["events"]
summary = "hygzz.top首页恢复：基金审计测试页备份至archive/后，旧版SXJ门户首页复位于index.html，站内导航自洽"
phase = "OPS"
ts = "20260830225400"
...
ev = {"code": code, "summary": summary, "phase": phase, "timestamp": ts, "seq": seq, "hash8": h8,
      "verify": "https://hygzz.top/ E1-200; 备份archive/index_fund_audit_20260825.html",
